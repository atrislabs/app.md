...
The proof loop is documented too: [RECEIPTS.md](./RECEIPTS.md) names the status, owner, verifier, decision, and learned fields that let app runs become auditable improvement.
